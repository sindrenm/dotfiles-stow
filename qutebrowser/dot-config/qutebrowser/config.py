...
#   - no-3rdparty: Accept cookies from the same origin only. This i
#     known to break some sites, such as GMail.
...
config.set(
    ...
    True,
    "file:///home/sindre/.local/share/qutebrowser/userscripts/*",
)
